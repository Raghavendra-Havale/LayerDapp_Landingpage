...
function Community() {
  ...
  return (
    <section className="pt-10 md:pt-20 lg:pt-28 bg-[#151D29] z-100">
      <img
        src={communityBlur}
        className="absolute h-[550px] w-full top-[4100px]"
      />
      <div
              ...
              <div>
                ...
                <div className="flex flex-row justify-around mt-12  text-center mb-14 text-white dark:text-white">
                  <span className="border-r-4 w-[120px] border-gray-600  text-gray-600 font-bold">
                    TVL
                    <p className="text-3xl text-white ">${currentUser.tvl} </p>{" "}
                  </span>
                  <span className="border-r-4 w-[120px] border-gray-600  text-gray-600 font-bold">
                    24hr{" "}
                    <p className="text-3xl text-white">${currentUser.hr} </p>
                  </span>
                  <span className="text-gray-600 font-bold">
                    Reward{" "}
                    <p className="text-3xl text-white">${currentUser.reward}</p>
                  </span>
                </div>
              </div>
            </div>
